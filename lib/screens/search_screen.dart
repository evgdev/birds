...
//       body: BodyLayout(searchValue: widget.searchValue),
...
//   BodyLayout({super.key, required this.searchValue});
//   @override
//   State<BodyLayout> createState() => _BodyLayoutState();
// }

// class _BodyLayoutState extends State<BodyLayout> {
//   final List<BirdDataModel> _birds = [
//     BirdDataModel(
//         name: "Большая синица",
//         latin: 'Parus major',
//         family: "Синицевые",
...
//   @override
//   Widget build(BuildContext context) {
//     return _myListView(context, birds: _birds, searchValue: widget.searchValue);
//   }
// }

// Widget _myListView(BuildContext context,
//     {required List<BirdDataModel> birds, required String searchValue}) {
//   final List<BirdDataModel> results = birds
//       .where(
//           (bird) => bird.name.toLowerCase().contains(searchValue.toLowerCase()))
//       .toList();
