...
class DetailsScreenBig extends StatefulWidget {
  final BirdDataModel bird;
  final String pic;
  const DetailsScreenBig({Key? key, required this.bird, required this.pic})
      : super(key: key);

  @override
  State<DetailsScreenBig> createState() => _DetailsScreenBigState();
}

class _DetailsScreenBigState extends State<DetailsScreenBig> {
  @override
